...
import { GlobalCryptoInfoItem, GlobalCryptoInfoResponse } from './coinloreDataTypes';

export const transformGlobalCryptoInfoResponse = (resp: GlobalCryptoInfoResponse): GlobalCryptoInfoItem[] => {
  return [
    {
      key: 0,
